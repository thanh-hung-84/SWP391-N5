...
public class InterviewModel {
    ...
    public String getBaremName() { return baremName; }
    public void setBaremName(String baremName) { this.baremName = baremName; }

    public int getInterviewRound() { return interviewRound; }
    public void setInterviewRound(int interviewRound) { this.interviewRound = interviewRound; }
    ...
    public List<StaffModel> getParticipants() { return participants; }
    public void setParticipants(List<StaffModel> participants) { this.participants = participants; }
