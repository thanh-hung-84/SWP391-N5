...
public class BaremModel {
    ...
    public List<CriteriaModel> getCriteriaList() { return criteriaList; }
    public void setCriteriaList(List<CriteriaModel> criteriaList) { this.criteriaList = criteriaList; }
}
